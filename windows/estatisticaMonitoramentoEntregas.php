            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="cobrancaIndevida">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Valor incorreto</th>
                        <td id="valorIncorreto">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Pedido incompleto</th>
                        <td id="pedidoIncompleto">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Pedido não entregue</th>
                        <td id="pedidoNaoEntregue">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Erro engenharia</th>
                        <td id="erroEngenharia">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Atendimento</th>
                        <td id="atendimento">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Avarias</th>
                        <td id="avarias">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Arranhados</th>
                        <td id="arranhados">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Atraso entrega</th>
                        <td id="atrasoEntrega">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Vendedor</th>
                        <td id="vendedor">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Representante</th>
                        <td id="representante">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Motorista</th>
                        <td id="motorista">placeholder</td>
                    </tr>
                    <tr>
                        <th scope="row">Carregador</th>
                        <td id="carregador">placeholder</td>
                    </tr>
                </tbody>
            </table>
